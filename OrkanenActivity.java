...
public class OrkanenActivity extends AppCompatActivity {
    ...
    public void showroom(View view) {
        ...
        if (res.startsWith("A") || res.startsWith("B") || res.startsWith("C")|| res.startsWith("a") || res.startsWith("b") || res.startsWith("c")) {
            ...
            } else if (res.length() > 1 && String.valueOf(res.charAt(1)).equals("1")) {
                // OM ABC OCH 1***
            ...
            } else if (res.length() > 1 && String.valueOf(res.charAt(1)).equals("2")) {
                // OM ABC OCH 2***
            ...
            } else if (res.length() > 1 && String.valueOf(res.charAt(1)).equals("3")) {
                // OM ABC OCH 3***
            ...
            } else if (res.length() > 1 && String.valueOf(res.charAt(1)).equals("4")) {
                // OM ABC och 4**
            ...
            } else if (res.length() > 1 && String.valueOf(res.charAt(1)).equals("5")) {
                // OM ABC och 5**
